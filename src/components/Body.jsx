	...
	return listOfRestaurants?.length === 0 ? (
		...
		<>
			<div className="flex justify-center items-center gap-3 my-8">
				<input
					type="text"
					className="py-3 px-4 w-96 border-solid border-[1px] border-inherit rounded-full outline-none transition-colors duration-400 focus:border-[#ff6f00]"
				...
				/>
				<button
					className="px-5 py-2.5 bg-[#ff6f00] text-white text-base font-normal rounded-full cursor-pointer transition-colors duration-300 hover:bg-[#e65c00] hidden sm:inline-block"
					onClick={(e) => {
						handleSearch(e);
					}}>
					Search
